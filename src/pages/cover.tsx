      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
        ...
        <form style={{
          ...
          <div style={{ backgroundColor: 'darkgray', ...divStyle }}>
            <select onChange={({ target }) => setFit(target.value)} name="fit" id="fit" form="imageStyle" style={{
              backgroundColor: '#4daf7c', width: '100%', textAlign: 'center', fontSize: '1.8em', fontFamily: '"Bebas Neue", Arial', border: '0',
              outline: '0',
              color: '#fff',
            }}>
          ...
          <div style={{ backgroundColor: 'darkgray', ...divStyle }}>
            <select onChange={({ target }) => setPosition(target.value)} name="Position" id="position" form="imageStyle" style={{
              backgroundColor: '#404241', width: '100%', textAlign: 'center', fontSize: '1.8em', fontFamily: '"Bebas Neue", Arial', border: '0',
              outline: '0',
              color: '#fff',
            }}>
          ...
          <div style={{ backgroundColor: 'darkgray', ...divStyle }}>
            <select onChange={({ target }) => setOrientation(target.value)} name="Ausrichtung" id="position" form="imageStyle" style={{
              backgroundColor: '#4daf7c', width: '100%', textAlign: 'center', fontSize: '1.8em', fontFamily: '"Bebas Neue", Arial', border: '0',
              outline: '0',
              color: '#fff',
            }}>
          ...
          <div style={{ backgroundColor: 'darkgray', ...divStyle }}>
            <select onChange={({ target }) => setTarget(target.value)} name="Target" id="target" form="imageStyle" style={{
              backgroundColor: '#e9c85d', width: '100%', textAlign: 'center', fontSize: '1.8em', fontFamily: '"Bebas Neue", Arial', border: '0',
              outline: '0',
              color: '#fff',
            }}>
